# vLLM v0.29.0 Deployment Patches

These 17 patches apply in filename order to the official vLLM v0.29.0
Python package. They were generated from
`tinfoilsh/vllm-cc-opt:milestone/gemma4-cc-v0290-v1-20260909` at
commit `3e0a9ddc3637b1d50cdcd5c953206ae69c4765a5` (the v0.25.1 series
rebased onto v0.28.0, then v0.29.0).
...
- `0104` (Gemma 4 MTP embedding sharing, upstream `b2b8f679d`) is in the
  v0.29.0 tag, with additional upstream hardening (`272abd5f48`).
- `0105` (avoid reasoning-parser token history copies): v0.29.0 ships the
...
remains fully supported at v0.29.0.
...
The script checks out v0.29.0, applies all 17 patches with zero fuzz, and
