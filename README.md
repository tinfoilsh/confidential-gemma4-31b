...
vLLM v0.29.0 (rebased from the B300-validated v0.25.1 series; full-CC
...
```
confidential-gemma4-31b/
├── Dockerfile                 builds on the digest-pinned vLLM v0.29.0 base
...
`tinfoilsh/vllm-cc-opt:milestone/gemma4-cc-v0290-v1-20260909`.
